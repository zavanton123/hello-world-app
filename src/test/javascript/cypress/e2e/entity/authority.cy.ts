...
describe('Authority e2e test', () => {
  ...
  const authoritySample = { name: 'f183f4fc-b524-4650-b9a9-a18f880607bb' };
  ...
  describe('new Authority page', () => {
    ...
    it('should create an instance of Authority', () => {
      cy.get(`[data-cy="name"]`).type('6bd3422a-4610-4f07-bb2a-dbebf28e64f5');
      cy.get(`[data-cy="name"]`).should('have.value', '6bd3422a-4610-4f07-bb2a-dbebf28e64f5');
